...
1. Run the following script: `npm run customize:makeityours` and follow the prompts. <span style="color: red">This will delete and replace ./ios ./android and app.json</span>
